...
{
    public record FileSelectionFileSystem(FileSelection FileSelection) : IFileSystem, IDirectory, IFile
    {
        ...
        /// <inheritdoc />
        public Task<string> ReadAllTextAsync(string path, CancellationToken cancellationToken = new()) => ReadAllTextAsync(path, Encoding.Default, cancellationToken);

        /// <inheritdoc />
        public async Task<string> ReadAllTextAsync(string path, IEncoding encoding, CancellationToken cancellationToken = new())
        {
        ...
        /// <inheritdoc />
        public async Task WriteAllTextAsync(string path, string content, CancellationToken cancellationToken = new())
        {
            throw new NotImplementedException();
        }

        /// <inheritdoc />
        public async Task WriteAllTextAsync(string path, string content, IEncoding encoding,
        ...
        /// <inheritdoc />
        public async Task WriteAllTextAsync(string path, string content, Encoding encoding,
            CancellationToken cancellationToken = new())
        {
            throw new NotImplementedException();
        }
        ...
        /// <inheritdoc />
        public async Task<string[]> ReadAllLinesAsync(string path, IEncoding encoding, CancellationToken cancellationToken = new())
        {
            throw new NotImplementedException();
        }
        ...
        /// <inheritdoc />
        public async Task WriteAllLinesAsync(string path, IEnumerable<string> contents, IEncoding encoding,
            CancellationToken cancellationToken = new())
        {
            throw new NotImplementedException();
        }
        ...
        /// <inheritdoc />
        public async Task AppendAllLinesAsync(string path, IEnumerable<string> contents, IEncoding encoding,
            CancellationToken cancellationToken = new())
        {
            throw new NotImplementedException();
        }
        ...
        /// <inheritdoc />
        public async Task AppendAllTextAsync(string path, string content, CancellationToken cancellationToken = new())
        {
            throw new NotImplementedException();
        }

        /// <inheritdoc />
        public async Task AppendAllTextAsync(string path, string content, IEncoding encoding,
            CancellationToken cancellationToken = new())
        {
            throw new NotImplementedException();
        }
        ...
        /// <inheritdoc />
        public async Task AppendAllTextAsync(string path, string content, Encoding encoding,
            CancellationToken cancellationToken = new())
        {
            throw new NotImplementedException();
        }
        ...
        {
            return FileSelection.FileTextDictionary.ContainsKey(path);
        }
        ...
        {
            return new FakeFileStreamAdapter(FileSelection.FileTextDictionary[path]);
        }
        ...
        {
            return FileSelection.FileTextDictionary[path];
        }
